# Django settings for wwwdocker project.
...
INTERCOM_ENABLE_INBOX = False
INTERCOM_ENABLE_INBOX_COUNTER = False
# google analytics
GOOGLE_ANALYTICS_PROPERTY_ID = 'UA-6096819-11'

# we want to track site speed.
